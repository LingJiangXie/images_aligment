...
def face_aligment(raw_images_dir,aliged_images_dir,landmarks_dir):
    ...
    for line in lines:
        ...
        for i in range(5):
            ...
            pts.append([int(line[2 * i + 1]), int(line[2 * i + 2])])
...
face_aligment('/home/dany/Downloads/lfw','/home/dany/Documents/datasets/lfw_112_96','/home/dany/Downloads/sphereface_pytorch-master/data/lfw_landmark.txt')